  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', alignItems: 'center' }}>
        <Anchor align='justify' color='blue' size='md' my={20} href='https://github.com/aryan877/Next-Movie-Recommender' target="_blank">
          Project Github Repo (Frontend)
          <ExternalLink />
        </Anchor>
      </div>
      <div style={{ display: 'flex', alignItems: 'center' }}>
        <Anchor align='justify' color='blue' size='md' mb={20} href='https://github.com/aryan877/recommender-script' target="_blank">
