...
function Working() {
  return (
    <>
      ...
      <Link href="/about" as={`https://github.com/aryan877/movierecommendernextjs`}>
        <a target='_blank' style={{ cursor: "pointer", textDecoration: "none" }}>
          <Text my={40} align="justify" color="blue" size="lg">Project Github Repo</Text>
        </a>
      </Link>
